    ...
    requestBody: {
      content: {
        "application/json": {
          ...
          code?: string;
          /**
           * @description Optional explicit step selector — `first_factor` or
           * `second_factor`. Disambiguates code-only attempts where
           * `identifier` happens to be absent.
           *
           * @enum {string}
           */
          strategy?: "first_factor" | "second_factor";
          webauthn_response?: {
            [key: string]: unknown;
          };
        };
