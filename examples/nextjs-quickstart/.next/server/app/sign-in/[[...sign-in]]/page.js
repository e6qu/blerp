    ...
    (e.modules = {
                  ...
                  children: [
                    "[[...sign-in]]",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(r.bind(r, 5109)),
                            "/Users/zardoz/projects/blerp/examples/nextjs-quickstart/src/app/sign-in/[[...sign-in]]/page.tsx",
                          ],
                        },
                      ],
                    },
      ...
      1980: (e, t, r) => {
        ...
        function c({ children: e, publishableKey: t }) {
          let r = (0, n.useMemo)(
              () => (0, i.Ay)({ baseUrl: "/", headers: { Authorization: `Bearer ${t}` } }),
              [t],
            ),
            o = (0, n.useMemo)(
          ...
          return (0, s.jsx)(l.Ht, {
            client: a,
            children: (0, s.jsx)(d.Provider, { value: o, children: e }),
          });
        }
        function u() {
      ...
      2697: (e, t, r) => {
        "use strict";
        (r.r(t), r.d(t, { SignIn: () => n, UserButton: () => i }));
        var s = r(5512);
        function n() {
          return (0, s.jsxs)("div", {
              ...
              (0, s.jsxs)("div", {
                ...
                children: [
                  (0, s.jsxs)("button", {
                    ...
                    children: [(0, s.jsx)(i.A, { className: "mr-2 h-4 w-4" }), "GitHub"],
                  }),
                  (0, s.jsxs)("button", {
                    onClick: () => u("google"),
                    className:
                      "flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50",
                    children: [(0, s.jsx)(o.A, { className: "mr-2 h-4 w-4" }), "Google"],
                  }),
                ],
              }),
              (0, s.jsxs)("div", {
      ...
      9932: (e, t, r) => {
        "use strict";
        r.d(t, { BlerpProvider: () => n, useAuth: () => i });
        var s = r(6760);
      ...
      8184: (e, t, r) => {
        "use strict";
        r.d(t, { F4: () => s.BlerpProvider, Hx: () => n.SignUp, Ls: () => i.SignIn });
        var s = r(9932),
          n = r(8455),
          i = r(4889);
        r(1415);
