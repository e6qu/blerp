      ...
      let S = a.default.forwardRef(function (e, t) {
        ...
        let H = x ? n && "object" == typeof n && n.ref : t,
          ...
          V = a.default.useCallback(
            (e) => {
              ((G.current !== X || W.current !== F) && (K(), (G.current = X), (W.current = F)),
                B(e));
            },
            [X, F, K, B],
          ),
        ...
        let q = {
          ...
          onMouseEnter(e) {
            (x || "function" != typeof I || I(e),
              ...
              L &&
                (U || !D) &&
                R(L, F, X, { locale: T, priority: !0, bypassPrefetchedCheck: !0 }, { kind: k }, D));
          },
        ...
        if ((0, l.isAbsoluteUrl)(X)) q.href = X;
          ...
          q.href =
            t || (0, _.addBasePath)((0, c.addLocale)(X, e, null == M ? void 0 : M.defaultLocale));
        }
        return x ? a.default.cloneElement(n, q) : (0, o.jsx)("a", { ...j, ...q, children: r });
      });
      ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, "__esModule", { value: !0 }),
