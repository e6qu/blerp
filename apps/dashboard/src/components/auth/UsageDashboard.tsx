...
export function UsageDashboard() {
  ...
  if (!usage)
    return (
      <div className="p-4 text-sm text-gray-500 dark:text-gray-400">No usage data available</div>
    );
    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      <div className="rounded-xl border bg-white dark:bg-gray-800 p-6 shadow-sm">
        ...
        <div className="mt-2 flex items-baseline">
          <p className="text-2xl font-semibold text-gray-900 dark:text-gray-50">{usage.users}</p>
          <p className="ml-2 text-sm text-gray-500 dark:text-gray-400">
            of {usage.limits.maxUsers}
          </p>
        </div>
      ...
      <div className="rounded-xl border bg-white dark:bg-gray-800 p-6 shadow-sm">
        ...
        <div className="mt-2 flex items-baseline">
          ...
          <p className="ml-2 text-sm text-gray-500 dark:text-gray-400">
            of {usage.limits.maxOrganizations}
          </p>
        </div>
        <div className="mt-4 h-2 w-full rounded-full bg-gray-100 dark:bg-gray-700">
