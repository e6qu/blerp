...
export function DeleteProjectModal({ isOpen, onClose, projectName }: DeleteProjectModalProps) {
      ...
      <div className="relative z-10 w-full max-w-md rounded-xl border border-red-200 dark:border-red-800 bg-white dark:bg-gray-800 p-6 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50">Delete Project</h2>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="mb-4 rounded-lg bg-red-50 dark:bg-red-900/20 p-3">
          <p className="text-sm text-red-700 dark:text-red-400">
            This action cannot be undone. This will permanently delete the project, all API keys,
            organizations, users, and associated data.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={deleteProject.isPending || confirmation !== projectName}
